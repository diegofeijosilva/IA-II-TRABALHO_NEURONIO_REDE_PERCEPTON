//Exemplo - Rede Perceptron com 2 neuronios

/*
Resultado da Execução
 
 1 Neurônio 
 Total de erros: 869513
 Total de acertos: 1323391

 2 Neurônios // Pior resultado
 Total de erros: 1017644
 Total de acertos: 4562539
...
public class PerceptronRendaDividaV2 {
		...
		while (true) {
			...
			for (i = 0; i < x1.length; i++) {
				...
				if (erro != 0) {
					...
					// propagação 2
					y = neuronio2.calculaY(x1[i], x2[i]);
